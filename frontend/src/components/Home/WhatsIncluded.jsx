            ...
            <div className="px-6 mx-auto max-w-7xl lg:px-8">
                <div className="flex flex-col items-center justify-center max-w-5xl mx-auto lg:text-center">
                    ...
                    <p className="max-w-2xl mt-6 text-center text-md">
                        Resonate helps audio professionals work with their clients with ease.
                ...
                <section className="h-[400px] mx-auto mt-16 max-w-3xl sm:mt-20 lg:mt-24 lg:max-w-5xl">
                    <dl className="grid max-w-xl grid-cols-1 gap-x-8 gap-y-10 lg:max-w-none lg:grid-cols-2 lg:gap-y-16">
                        <div className="relative pl-16">
                            <dt className="text-base font-semibold leading-7 text-primary">
                                <div className="absolute top-0 left-0 flex items-center justify-center w-12 h-12 rounded-lg bg-primary">
                                    <FolderUp className="w-6 h-6 text-neutral-800" />
                                </div>
                        ...
                        <div className="relative pl-16">
                            <dt className="text-base font-semibold leading-7 text-primary">
                                <div className="absolute top-0 left-0 flex items-center justify-center w-12 h-12 rounded-lg bg-primary">
                                    <MessagesSquare className="w-6 h-6 text-neutral-800" />
                                </div>
                        ...
                        <div className="relative pl-16">
                            <dt className="text-base font-semibold leading-7 text-primary">
                                <div className="absolute top-0 left-0 flex items-center justify-center w-12 h-12 rounded-lg bg-primary">
                                    <MessageCircleQuestion className="w-6 h-6 text-neutral-800" />
                                </div>
